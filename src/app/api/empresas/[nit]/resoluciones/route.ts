...
export async function GET(
  ...
  try {
    ...
    const empresaResult = await ResolucionService.getEmpresaByNit(nit);
    ...
    const result = await ResolucionService.getByEmpresaId(empresaId);
...
export async function POST(
  ...
  try {
    ...
    const result = await ResolucionService.create(resolucionData);
