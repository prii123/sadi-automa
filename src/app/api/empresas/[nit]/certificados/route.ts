...
export async function GET(
  ...
  try {
    ...
    const empresaResult = await CertificadoService.getEmpresaByNit(nit);
    ...
    const result = await CertificadoService.getByEmpresaId(empresaId);
...
export async function POST(
  ...
  try {
    ...
    const result = await CertificadoService.create(certificadoData);
