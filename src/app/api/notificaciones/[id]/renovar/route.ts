...
// POST /api/notificaciones/[id]/renovar - Marcar documento como renovado
export async function POST(
  ...
  try {
    ...
    if (result && result.success) {
      ...
      return NextResponse.json({ success: false, error: 'Error al marcar como renovado' }, { status: 400 });
    }
  } catch (error) {
